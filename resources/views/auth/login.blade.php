...
<div class="container mx-auto mt-16 mb-24">
	<p class="text-3xl text-center text-white">Sign In</p>
	<p class="text-md text-gray-500 mt-2 text-center">Sign In and get exclusive discount and rewards.</p>
	<div class="flex items-center justify-center mt-12">
		<form action="/login" method="post" class="bg-gray-800 px-6 py-6 rounded">
			@csrf
			...
			<button type="submit" class="mt-5 rounded bg-gray-700 text-white px-2 py-2 transition duration-150 ease-in-out hover:bg-gray-600">Sign In</button>
		</form>
	</div>
</div>
@endsection
