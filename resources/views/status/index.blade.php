...
<div class="container mx-auto mt-16">
	...
	<p class="text-red-500 text-center font-bold text-lg mt-2">(Every items that has been checkout, use the payment method that has been sent to your register email)</p>
	@if($data->count() == 0)
