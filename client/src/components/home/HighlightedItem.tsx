...
const HighlightedItem = () => {
  return (
    <div className='flex flex-col md:flex-row'>
      <div className='flex flex-1 items-center justify-between bg-gradient-to-l from-[#6CB9EF] to-[#2B88D6] px-12 py-7 md:flex-row flex-col flex-col-reverse gap-4'>
      ...
      <div className='flex flex-1 items-center justify-between bg-gradient-to-l from-[#8A79EC] to-[#4D44DB] px-12 py-7 md:flex-row flex-col flex-col-reverse gap-4'>
        <div className='flex-1 text-white'>
          <Link to='/' className='bg-[#09274C] py-2 px-3 text-xs'>Detail</Link>
          <p className='text-sm mt-6 md:mt-8 mb-2'>Dior x Nike Jordan</p>
          <h2 className='text-2xl font-oswald'>Air Jordan</h2>
