...
const Brand = () => {
  ...
  return (
    <>
        ...
        <div className='px-10 py-5 w-full'>
          ...
          <div className='font-opensans mt-9'>
            <div className='flex items-center justify-between gap-10'>
              ...
              <button className='bg-blue-500 rounded-full px-5 py-2 hover:bg-blue-600 transition-[background] text-sm text-white' onClick={() => setOpenCreateBrandModal(true)}>Create Brand</button>
            </div>
      ...
      <CreateBrandModal createBrandRef={createBrandRef} openCreateBrandModal={openCreateBrandModal} setOpenCreateBrandModal={setOpenCreateBrandModal} />
    </>
  )
}
